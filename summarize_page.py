...
import pyrebase
from feedback import grammar_errors,ideal_summary
...
def scale_function(content,wording):
    ...
    if 0 <= overall_percentage < 30:
        performance = "Poor"
    elif 30 <= overall_percentage < 45:
        performance = "Below Average"
    elif 45 <= overall_percentage < 65:
        performance = "Average"
    elif 65 <= overall_percentage < 85:
        performance = "Good"
